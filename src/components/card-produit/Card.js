...
:<></>
      }  
    {
      ...
      :<></>
        ...
        <div  onClick={link}><img src={"http://localhost:8080/uploads/"+props.imgp} className="img-cardprod"/></div>
          ...
          <div>
            <div className="grb-card22">
              <div>
                ...
                <img src={"http://localhost:8080/uploads/"+props.logoL} className="logolib"/>
              </div>
              <div>
