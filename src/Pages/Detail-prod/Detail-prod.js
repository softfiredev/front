          ...
          <div className='row10-detail'>
            ...
            <div>
              <div className='col4-detail'>
                    ...
                    <div className='coll33-detail'>
                      <div className='row6-detail'>
                        ...
                        <div>   <div className="progressbar">
                          <div className="indicator"  style={{  width: "205px"}}></div>
                        </div>
                ...
                <div>
                  <p className='txt7-detail' onClick={handleOpen}>Donnez votre avis</p>
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
           ...
           <p className='txtmodal-detail'>Ajouter votre avis</p><br/>
          </Typography>
          ...
          <OutlinedInput className='inpu-conn2-modal' placeholder="Message" multiline rows={5} maxRows={80} />
            ...
            <div className='coll3-detail'>
              ...
              <div className='coll4-detail'>
                ...
                <div><Rating name="read-only" value={value2} readOnly /></div>
