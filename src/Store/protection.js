...
if((location.pathname==="/partenaire"|| location.pathname==="/partenaire/commandes"|| location.pathname==="/partenaire/Mes_points"|| location.pathname==="/partenaire/Mes_Favoris"|| location.pathname==="/partenaire/Profile" ))
{
  return children
}
else{return <Navigate to="/" />}
