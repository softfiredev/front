...
const Become_a_Partner = () => {
 ...
 <div className='group-partner '>
    ...
    <div>
      ...
      <div className='txt100-become'>Opportunités avec “Maktaba.tn”</div>
      <div className='txt101-become'>Chez Maktba.tn, notre plateforme avancée alimentée par l'IA simplifie la commercialisation et la logistique des fournitures éducatives, des livres et des jouets. En tant que partenaire, vous bénéficiez de données en temps réel pour une meilleure prise de décision et de la possibilité de gérer vos propres projets. Joignez-vous à notre communauté pour rationaliser votre chaîne d'approvisionnement, augmenter l'efficacité et faire un impact positif dans votre région. Rejoignez-nous dès aujourd'hui pour un avenir meilleur.</div>
      </div>
      
      
      </div>
    <div><img src={Part} className='img-become'/></div>
        </div>
      </Grid>
      <div className='brr'></div>
      ...
      <Grid item>
        <div className='grbs' >
       <div><div className='txtp'>Envoyez-nous une demande si vous êtes intéressé. Vous serez bientôt contacté par notre équipe pour confirmer.</div></div> 
       <Grid container direction="column" spacing={6} >
              <Grid item>
           ...
           <div className='box-b'>
             <Grid container direction="column" justifyContent="center" alignItems="flex-start" spacing={5}  >
              ...
              <Grid container direction="column" justifyContent="center" alignItems="center" spacing={3}  >
               ...
               <Grid item>
                 <Grid container direction="column" justifyContent="center" alignItems="flex-start" spacing={4}  >
                 <Grid item>  <div className='txt80-become'>Votre choix de pack*</div></Grid>          
                 <Grid item className="Cardbecome">  <Cardbecome />  </Grid> 
                 </Grid>
               </Grid>
...
ses prestations. Vous ne trouvez pas la réponse que vous cherchez?
