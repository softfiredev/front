...
const Admin = () => {
  ...
  const linkarray = [
    ...
    {
      linkname:<div className="row-admin"><div>Partners </div><div className="circule"><p style={{color:" #222222",fontSize:"10px",fontFamily:"Inter",fontWeight:"600"}}>+4</p></div></div>,
