        ...
        <Grid item>
          <div className="home">
            <div className="home-cont">
              <Grid container direction="column" spacing={6}>
                <Grid item>
                  ...
                  <p className="txt1-home">L'univers de fournitures scolaires</p> 
                </Grid>
                <Grid item>
           ...
           <div>
              ...
              <div className='circule'><div className='cont-circule'> {obj.icon}</div></div>
...
<div className='col3-hom' >
  ...
  {cat.map((obj) =>
        ...
        <div >
<div className='col3-hom' >
  <div > <p className='txt5-home'>Actualités</p>    </div>
  <div >  
