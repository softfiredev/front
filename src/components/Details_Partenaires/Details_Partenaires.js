...
import "./Details_Partenaires.css"
...
const Details_Partenaires = () => {
 ...
 <div
      ...
      <div className='mrow-Details_client'>
        <Avatar src='' className='avtar-Details_client'/>
        <div><p className='txt-Details_client'>Otis Hoppe</p></div>
      </div>
 </div>
...
export default Details_Partenaires
